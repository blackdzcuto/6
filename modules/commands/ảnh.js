...
`, event.threadID, event.messageID);
     ...
     if (args[0] == "vú") {
    axios.get('https://Ryanair-Web-Api-Phan-Duy.truccuche27042004.repl.co/api/gaivuto.php').then(res => {
    ...
    if (args[0] == "trai") {
    axios.get('https://Ryanair-Web-Api-Phan-Duy.truccuche27042004.repl.co/api/trai.php').then(res => {
        let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
        let callback = function() {
            return api.sendMessage({
  ...
  if (args[0] == "hentai") {
    axios.get('https://Ryanair-Web-Api-Phan-Duy.truccuche27042004.repl.co/api/hentai.php').then(res => {
        let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
        let callback = function() {
            return api.sendMessage({
  ...
  if (args[0] == "sexy") {
    axios.get('https://Ryanair-Web-Api-Phan-Duy.truccuche27042004.repl.co/api/gaiditbu.php/api/gaisexy.php').then(res => {
        let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
        let callback = function() {
            return api.sendMessage({
  ...
  if (args[0] == "nude") {
    axios.get('https://Ryanair-Web-Api-Phan-Duy.truccuche27042004.repl.co/api/nude.php').then(res => {
        let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
        let callback = function() {
            return api.sendMessage({
  ...
  if (args[0] == "cosplay") {
    axios.get('https://Ryanair-Web-Api-Phan-Duy.truccuche27042004.repl.co/api/cosplay.php').then(res => {
        let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
        let callback = function() {
            return api.sendMessage({
 ...
 if (args[0] == "gái") {
axios.get('https://Ryanair-Web-Api-Phan-Duy.truccuche27042004.repl.co/api/gai.php').then(res => {
        let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
        let callback = function() {
            return api.sendMessage({
